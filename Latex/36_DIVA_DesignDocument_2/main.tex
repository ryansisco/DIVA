...
\begin{tabular}{ |p{5cm}|p{5cm}|p{5cm}|  }
 ...
 \hline
 3 Definition & Definition of MP4 and MOV & Removed both definition of MP4 and MOV\\
 \hline
 5.6.3 WebGL & Mentioned that timeline interaction as part of the project & Removed time line integration for 3D environment\\
 \hline
 5.6.4 Media Export & Media Export mentioned to export media as MOV or MP4 & Removed media export in MOV and MP4\\
 \hline
 5.7.1 CSV input & filter Option & changed filter to render option\\
 \hline
 5.7.2 Rendering & colorOverlay and graphOverlay & removed both overlay and combine into filter overlay\\
 \hline
 5.9 Design Languages & WebGL passed as c++ code & Remove both WebGL and c++ code to CSV parsing with Python code\\
 \hline
 6.2.2 Design Elements & be able to graph 2D and 3D environment & Remove the ability to graph in 3D environment\\
 \hline
 6.5 Interaction Viewpoint & pre-rendering module which edits parsed CSV values & Removed edit CSV values and change to filter out the values\\
